...
use crate::{
    AttractAnimState, AttractSymbol, AutoGenTimers, DetailHint, DetailIcon, DetailName, DragGhost,
    DragState, EggStorage, IdleTimer, MessageBar, MessageLabel, RisingStar, StarSpawnTimer,
    SubmitBtn, ACCENT, ATTRACT_IDLE_SECS, ATTRACT_MAX_DURATION, ATTRACT_MIN_DURATION,
    ATTRACT_SPARKLE_INTERVAL, CELL_EMPTY, CELL_EMPTY_ALT, CELL_HOVERED, CELL_SELECTED,
    DRAG_THRESHOLD_PIXELS, SECONDS_PER_MINUTE, STAR_SPAWN_INTERVAL,
};
